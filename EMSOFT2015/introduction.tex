...
{\it Today we have theories that deal with high-level planning in a discrete grid world: where the car should go given where everyone else is. E.g., \cite{WongpiromsarnTM10hscc} \todo[inline]{cite controller synthesis ufuk,belta,vasu,nezmiye}}
